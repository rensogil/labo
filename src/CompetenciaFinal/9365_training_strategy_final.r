...
PARAM  <- list()
PARAM$experimento <- "TS9365_final"

PARAM$exp_input  <- "FE965_final"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 2019011, 201912, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107 )

PARAM$train$training     <- c( 201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 2019011, 201912, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )
