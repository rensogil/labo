...
PARAM$experimento  <- "HT7261_FE_ArbolPocoPrond"
...
dataset[ , campo2 := as.integer( mcaja_ahorror <312.02 & mtarjeta_visa_consumo < 815.3 & mprestamos_personales>=14041 ) ]

dataset[ , campo3 := as.integer( mcaja_ahorro <312.02 & mtarjeta_visa_consumo>= 815.3 & Visa_msaldototal <25849 ) ]
dataset[ , campo4 := as.integer( ctrx_quarter <312.02 & mtarjeta_visa_consumo>= 815.3 & Visa_msaldototal>=25849 ) ]

dataset[ , campo5 := as.integer( mcaja_ahorror>=312.02 & cpayroll_trx< 1  & mtarjeta_visa_consumo<3946.4) ]
dataset[ , campo6 := as.integer( ctrx_quarter>=312.02 & cpayroll_trx< 1  & mtarjeta_visa_consumo>=3946.4) ]

dataset[ , campo7 := as.integer( mcaja_ahorro>=312.02 & cpayroll_trxr>=1  & cmcomisiones_mantenimiento<1359.9  ) ]
