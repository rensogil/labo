...
PARAM <- list()
PARAM$experimento  <- "Ganancia_sin_FE_4"
...
PARAM$finalmodel$learning_rate     <-    0.0176087818545063   #0.0142501265
PARAM$finalmodel$num_iterations    <-    243  #615
PARAM$finalmodel$num_leaves        <-    272 #784
PARAM$finalmodel$min_data_in_leaf  <-   639  #5628
PARAM$finalmodel$feature_fraction  <-   0.594729864503654  #0.8382482539
...
Promedio_ganancias = resultado_1 %>%
  group_by(envios) %>%
  summarise(Promedio_ganancia = mean(ganancia))
