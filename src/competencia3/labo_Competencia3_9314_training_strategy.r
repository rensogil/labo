...
PARAM$exp_input  <- "FE954"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c( 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 202007 )

PARAM$train$training     <- c( 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202104 )
PARAM$train$validation   <- c( 202005 )
