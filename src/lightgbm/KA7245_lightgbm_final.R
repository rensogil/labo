...
# Utilizo el segundo valor de ganancia de HT7240 iteracion 86
PARAM$finalmodel$max_bin           <-     31
PARAM$finalmodel$learning_rate     <-      0.0482127106787369   #0.0142501265
PARAM$finalmodel$num_iterations    <-    300  #615
PARAM$finalmodel$num_leaves        <-   845  #784
PARAM$finalmodel$min_data_in_leaf  <-   4679  #5628
PARAM$finalmodel$feature_fraction  <-      0.51577423652712  #0.8382482539
