...
# Utilizo el 1° valor de ganancia de HT723 iteracion 150
PARAM$finalmodel$max_bin           <-     31
PARAM$finalmodel$learning_rate     <-     0.0944009364011443   #0.0142501265
PARAM$finalmodel$num_iterations    <-    1445  #615
PARAM$finalmodel$num_leaves        <-   1000  #784
PARAM$finalmodel$min_data_in_leaf  <-   113  #5628
PARAM$finalmodel$feature_fraction  <-   0.394984059069874  #0.8382482539
