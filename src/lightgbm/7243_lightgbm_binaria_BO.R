...
hs <- makeParamSet( 
         ...
         makeNumericParam("max_depth",        lower= -1      , upper= 0),
         makeIntegerParam("min_gain_to_split",lower= 0.0     , upper= 1000),
         makeNumericParam("lambda_l1",        lower= 0.0     , upper= 50),
         makeNumericParam("lambda_l2",        lower= 0.0     , upper= 50),
         makeNumericParam("max_bin",          lower= 0.0     , upper= 100)
