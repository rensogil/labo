...
# Utilizo el 1 valor de ganancia de HT7254 iteracion 44
PARAM$finalmodel$max_bin           <-     31
PARAM$finalmodel$learning_rate     <-     0.0545409436620985   #0.0142501265
PARAM$finalmodel$num_iterations    <-    356  #615
PARAM$finalmodel$num_leaves        <-   994  #784
PARAM$finalmodel$min_data_in_leaf  <-   5799  #5628
PARAM$finalmodel$feature_fraction  <-   0.400351487735104  #0.8382482539
