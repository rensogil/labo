...
PARAM$finalmodel$learning_rate     <-      0.0296189938352343   #0.0142501265
PARAM$finalmodel$num_iterations    <-    591  #615
PARAM$finalmodel$num_leaves        <-   1196  #784
PARAM$finalmodel$min_data_in_leaf  <-   5451  #5628
PARAM$finalmodel$feature_fraction  <-      0.768148722036983  #0.8382482539
