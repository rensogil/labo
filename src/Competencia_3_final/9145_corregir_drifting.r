...
campos_monetarios <- c(campos_monetarios, "total_consumos","total_deuda", "Master_fultimo_cierre","cpayroll_trx", "total_activos", "Visa_fultimo_cierre", "balance", "Master_Fvencimiento", "chomebanking_transacciones","ratio_deuda", "comisiones_x_trx", "ccallcenter_transacciones","balance_transferencias", "debitos_automaticos","consumo_promedio", "cpagomiscuentas", "pagado_sobre_saldo", "total_descuentos", "total_descuentos_sobre_consumos", "Master_Finiciomora" )
