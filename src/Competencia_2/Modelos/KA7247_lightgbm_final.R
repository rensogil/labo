...
# Utilizo el 2° valor de ganancia de HT723 iteracion 138
PARAM$finalmodel$max_bin           <-     18
PARAM$finalmodel$learning_rate     <-     0.0799229747147151   #0.0142501265
PARAM$finalmodel$num_iterations    <-    168  #615
PARAM$finalmodel$num_leaves        <-   974  #784
PARAM$finalmodel$min_data_in_leaf  <-   134  #5628
PARAM$finalmodel$feature_fraction  <-   0.268757902915808  #0.8382482539
PARAM$finalmodel$max_depth         <-   19
PARAM$finalmodel$min_gain_to_split <-   0.0
PARAM$finalmodel$lambda_l1         <-   23.8996750350959
PARAM$finalmodel$lambda_l2         <-   38.7503132535934
