...
# Utilizo el 2 valor de ganancia de HT7252 iteracion 69
PARAM$finalmodel$max_bin           <-     31
PARAM$finalmodel$learning_rate     <-     0.0597445385216006   #0.0142501265
PARAM$finalmodel$num_iterations    <-    340  #615
PARAM$finalmodel$num_leaves        <-   1391  #784
PARAM$finalmodel$min_data_in_leaf  <-   4781  #5628
PARAM$finalmodel$feature_fraction  <-   0.26410040222878  #0.8382482539
