...
# Utilizo el 1 valor de ganancia de HT7254 iteracion 41
PARAM$finalmodel$max_bin           <-     31
PARAM$finalmodel$learning_rate     <-     0.0696005347621492   #0.0142501265
PARAM$finalmodel$num_iterations    <-    275  #615
PARAM$finalmodel$num_leaves        <-   1037  #784
PARAM$finalmodel$min_data_in_leaf  <-   5769  #5628
PARAM$finalmodel$feature_fraction  <-   0.403188014788529  #0.8382482539
